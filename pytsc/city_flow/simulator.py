...
from pytsc.city_flow.retriever import Retriever
...
class Simulator(BaseSimulator):
    ...
    @property
    def sim_step(self):
        return self.sim_time - self.config.cityflow_config["initial_wait_time"]
